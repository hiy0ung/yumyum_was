...
public interface StatsMenuRepository extends JpaRepository<Order, Long> {
    ...
    ORDER BY o.id
""", nativeQuery = true)
    List<Object[]> findTodayTotalPriceAndQuantityByOrderDate();
    ...
    ORDER BY o.id
""", nativeQuery = true)
    List<Object[]> findDayTotalPriceAndQuantityByOrderDate(@Param("year") int year, @Param("month") int month, @Param("day") int day);
    ...
    ORDER BY o.id
""", nativeQuery = true)
    List<Object[]> findMonthTotalPriceAndQuantityByOrderDate(@Param("year") int year, @Param("month") int month);
}
